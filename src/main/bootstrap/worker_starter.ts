...
import { registerPort } from '@/main/core/worker/worker_mgr'
import MainWorkerActionEmitter from '@/main/core/worker/worker_main'
...
export default function () {
  const modules = import.meta.glob('@/main/workers/**/index.ts', {
    eager: true,
    query: '?modulePath'
  })
  ...
  for (const path of paths) {
    ...
    registerPort(name, worker as unknown as MessagePort, MainWorkerActionEmitter)
  }
